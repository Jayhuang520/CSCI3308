...
<html>
<!--
This is created by Zhi jie huang for hw4 cscsi 3308

-->

<head>
        <title> HW #4 Huang </title>
</head>
...
response = urllib2.urlopen('https://api.darksky.net/forecast/accfacbe8ca3d649d7d6c795856a888f/37.8267,-122.4233')
...
state_caps = {
                "AK":{'state': 'Alaska', 'capital': 'Juneau', 'latitude': 58.3019496, 'longitude': -134.4197339},
                "AL":{'state': 'Alabama', 'capital': 'Montgomery', 'latitude': 32.3669656, 'longitude': -86.3006484},
                # "AR":{'state': 'Arkansas', 'capital': 'Little Rock', 'latitude': 34.7464809, 'longitude': -92.2895947},
                #"AZ":{'state': 'Arizona', 'capital': 'Phoenix', 'latitude': 33.4485866, 'longitude': -112.0773455},
                #"CA":{'state': 'California', 'capital': 'Sacramento', 'latitude': 38.5815719, 'longitude': -121.4943995},
                "CO":{'state': 'Colorado', 'capital': 'Denver', 'latitude': 39.7391536, 'longitude': -104.9847033},
                # "CT":{'state': 'Connecticut', 'capital': 'Hartford', 'latitude': 41.7655582, 'longitude': -72.6906126614661},
                # "DE":{'state': 'Deleware', 'capital': 'Dover', 'latitude': 39.158168, 'longitude': -75.5243681},
                # "FL":{'state': 'Florida', 'capital': 'Tallahassee', 'latitude': 30.4380832, 'longitude': -84.2809331},
                # "GA":{'state': 'Georgia', 'capital': 'Atlanta', 'latitude': 33.7490987, 'longitude': -84.3901848},
                # "HI":{'state': 'Hawaii', 'capital': 'Honolulu', 'latitude': 21.304547, 'longitude': -157.8556763},
                # "IA":{'state': 'Iowa', 'capital': 'Des Moines', 'latitude': 41.5910641, 'longitude': -93.6037148},
                # "ID":{'state': 'Idaho', 'capital': 'Boise', 'latitude': 43.61656, 'longitude': -116.2008349},
                # "IL":{'state': 'Illinois', 'capital': 'Springfield', 'latitude': 39.7989763, 'longitude': -89.6443687},
                # "IN":{'state': 'Indiana', 'capital': 'Indianapolis', 'latitude': 39.7683331, 'longitude': -86.1583501},
                # "KS":{'state': 'Kansas', 'capital': 'Topeka', 'latitude': 39.0490111, 'longitude': -95.6775556},
                 "KY":{'state': 'Kentucky', 'capital': 'Frankfort', 'latitude': 38.2009055, 'longitude': -84.8732835},
                # "LA":{'state': 'Louisiana', 'capital': 'Baton Rouge', 'latitude': 30.4507462, 'longitude': -91.1545509},
                # "MA":{'state': 'Massachusetts', 'capital': 'Boston', 'latitude': 42.3604823, 'longitude': -71.0595677},
                # "MD":{'state': 'Maryland', 'capital': 'Annapolis', 'latitude': 38.9786401, 'longitude': -76.4927859},
                # "ME":{'state': 'Maine', 'capital': 'Augusta', 'latitude': 48.3668041, 'longitude': 10.8986971},
                # "MI":{'state': 'Michigan', 'capital': 'Lansing', 'latitude': 42.7337712, 'longitude': -84.5553804},
                # "MN":{'state': 'Minnesota', 'capital': 'Saint Paul', 'latitude': 43.697972, 'longitude': 7.1216304},
                # "MO":{'state': 'Missouri', 'capital': 'Jefferson City', 'latitude': 38.577359, 'longitude': -92.1724264},
                # "MS":{'state': 'Mississippi', 'capital': 'Jackson', 'latitude': 32.2990384, 'longitude': -90.184769},
                # "MT":{'state': 'Montana', 'capital': 'Helena', 'latitude': 46.5927122, 'longitude': -112.0361089},
                 "NC":{'state': 'North Carolina', 'capital': 'Raleigh', 'latitude': 35.7804015, 'longitude': -78.6390778},
                # "ND":{'state': 'North Dakota', 'capital': 'Bismarck', 'latitude': 46.8083268, 'longitude': -100.7837391},
                # "NE":{'state': 'Nebraska', 'capital': 'Lincoln', 'latitude': 40.8000554, 'longitude': -96.6674004},
                 "NH":{'state': 'New Hampshire', 'capital': 'Concord', 'latitude': 43.207106, 'longitude': -71.5370215},
                # "NJ":{'state': 'New Jersey', 'capital': 'Trenton', 'latitude': 40.2170575, 'longitude': -74.7429462},
                        # "NM":{'state': 'New Mexico', 'capital': 'Santa Fe', 'latitude': 35.6869996, 'longitude': -105.9377996},
                # "NV":{'state': 'Nevada', 'capital': 'Carson City', 'latitude': 39.1637984, 'longitude': -119.7674033},
                 "NY":{'state': 'New York', 'capital': 'Albany', 'latitude': 42.6511674, 'longitude': -73.7549679},
                # "OH":{'state': 'Ohio', 'capital': 'Columbus', 'latitude': 39.9622601, 'longitude': -83.0007064},
                # "OK":{'state': 'Oklahoma', 'capital': 'Oklahoma City', 'latitude': 35.4729886, 'longitude': -97.5170535},
                # "OR":{'state': 'Oregon', 'capital': 'Salem', 'latitude': 44.9391565, 'longitude': -123.0331209},
                # "PA":{'state': 'Pennsylvania', 'capital': 'Harrisburg', 'latitude': 40.2663107, 'longitude': -76.8861121},
                # "RI":{'state': 'Rhode Island', 'capital': 'Providence', 'latitude': 41.8239891, 'longitude': -71.4128342},
                # "SC":{'state': 'South Carolina', 'capital': 'Columbia', 'latitude': 2.893108, 'longitude': -73.7845142},
                # "SD":{'state': 'South Dakota', 'capital': 'Pierre', 'latitude': 44.3683045, 'longitude': -100.3511847},
                # "TN":{'state': 'Tennessee', 'capital': 'Nashville', 'latitude': 36.1622296, 'longitude': -86.774353},
                # "TX":{'state': 'Texas', 'capital': 'Austin', 'latitude': 30.2711286, 'longitude': -97.7436994},
                # "UT":{'state': 'Utah', 'capital': 'Salt Lake City', 'latitude': 40.7670126, 'longitude': -111.8904307},
                # "VA":{'state': 'Virginia', 'capital': 'Richmond', 'latitude': 37.5385087, 'longitude': -77.4342799},
                # "VT":{'state': 'Vermont', 'capital': 'Montpelier', 'latitude': 44.260015, 'longitude': -72.5753598},
                # "WA":{'state': 'Washington', 'capital': 'Olympia', 'latitude': 47.0450197, 'longitude': -122.8948724},
                # "WI":{'state': 'Wisconsin', 'capital': 'Madison', 'latitude': 43.074761, 'longitude': -89.3837612},
                # "WV":{'state': 'West Virginia', 'capital': 'Charleston', 'latitude': 32.7876012, 'longitude': -79.9402727},
                # "WY":{'state': 'Wyoming', 'capital': 'Cheyenne', 'latitude': 41.1399814, 'longitude': -104.8202461}
    }
...
'''
for i in state_caps:
	request = 'https://api.forecast.io/forecast/d83d64e44e37a96aa7f86b97774af5d8/{0},{1}'.format(state_caps[i]['latitude'],state_caps[i]['longitude'])
	response = urllib2.urlopen(request)
	data = json.loads(response.read())	
	temperature = data['currently']['temperature']
	
	#print "$('#{0}').css('fill','blue')".format(i)

	if temperature <= 10:
	   print "$('#{0}').css('fill','blue')".format(i)
	elif temperature>=11 and temperature <=30:
	   print "$('#{0}').css('fill','cyan')".format(i)
	elif temperature>=31 and temperature<=50:
	   print "$('#{0}').css('fill','cyan')".format(i)
	elif temperature>= 51 and temperature <=80:
	   print "$('#{0}').css('fill','green')".format(i)
	elif tmerparature> 80:
	   print "$('#{0}').css('fill','red')".format(i)
